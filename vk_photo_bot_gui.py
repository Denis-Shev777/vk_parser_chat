...
ORDER_KEYWORDS = [
    "беру", "возьму", "забираю", "куплю", "покупаю",
    "хочу заказать", "хочу купить", "хочу взять",
    "закажу", "заказать", "заказываю", "оформить заказ",
    "мне нужно", "мне нужны", "мне нужен",
    "отложите", "отложи",
    "оплачу", "оплатить", "оплата",
    "сколько стоит", "какая цена", "почем",
    "есть в наличии", "наличие есть",
    "хочу 1", "хочу 2", "хочу 3",
    "возьму 1", "возьму 2", "возьму 3",
]
